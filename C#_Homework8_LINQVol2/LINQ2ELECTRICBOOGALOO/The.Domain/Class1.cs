namespace The.Domain
{
    public class Car
    {
        ...
        {
            Console.WriteLine($"Model: {Model} MilesPerGalon: {MilesPerGalon} Cylinders: {Cylinders} HorsePower: {HorsePower} Weight: {Weight} AccelerationTime: {AccelerationTime} Origin: {Origin}");
        }
    }
